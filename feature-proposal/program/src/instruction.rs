...
pub fn propose(
    ...
    Instruction {
        ...
        accounts: vec![
            ...
            AccountMeta::new_readonly(solomka_program::system_program::id(), false),
...
mod tests {
    ...
    fn test_get_packed_len() {
        assert_eq!(
            ...
            solomka_program::borsh::get_packed_len::<FeatureProposalInstruction>()
        )
    }
