...
use solomka_program::{entrypoint::ProgramResult, program_error::ProgramError, pubkey::Pubkey};
...
solomka_program::declare_id!("TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA");
